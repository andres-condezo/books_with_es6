...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/js/modules/book.js":[function(require,module,exports) {
"use strict";
...
var Book = /*#__PURE__*/_createClass(function Book(newTitle, newAuthor) {
...
},{}],"src/js/modules/utilities.js":[function(require,module,exports) {
"use strict";
...
exports.$$ = $$;
},{}],"src/js/modules/bookApp.js":[function(require,module,exports) {
"use strict";
...
var $bookContainer = (0, _utilities.$)('#list-book');
var $errorMsgContainer = (0, _utilities.$)('.error-msg-container');

var _$$ = (0, _utilities.$$)('input'),
...
exports.default = _default;
},{"./book.js":"src/js/modules/book.js","./utilities.js":"src/js/modules/utilities.js"}],"src/js/modules/navigation.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.showPage = exports.addLinkFunction = void 0;

var _utilities = require("./utilities.js");

var linkArr = (0, _utilities.$$)('.menu-link');
var sectionArr = (0, _utilities.$$)('.section');

var activateSection = function activateSection(index) {
  linkArr[index].classList.add('activeLink');
  sectionArr[index].classList.remove('hideSection');
};

var deactivateSection = function deactivateSection(index) {
  linkArr[index].classList.remove('activeLink');
  sectionArr[index].classList.add('hideSection');
};

var showPage = function showPage(index) {
  sectionArr.forEach(function (_, i) {
    deactivateSection(i);
  });
...
var addLinkFunction = function addLinkFunction() {
  linkArr.forEach(function (btn, index) {
...
exports.addLinkFunction = addLinkFunction;
},{"./utilities.js":"src/js/modules/utilities.js"}],"node_modules/luxon/build/cjs-browser/luxon.js":[function(require,module,exports) {
'use strict';
...
exports.Zone = Zone;
},{}],"src/js/modules/luxon.js":[function(require,module,exports) {
"use strict";
...
var $dateContainer = (0, _utilities.$)('#date-container');

var showDate = function showDate() {
  setInterval(function () {
    var dt = _luxon.DateTime.now();

    $dateContainer.innerHTML = dt.toLocaleString(_luxon.DateTime.DATETIME_FULL_WITH_SECONDS).slice(0, -5);
  }, 1000);
};

var _default = showDate;
exports.default = _default;
},{"luxon":"node_modules/luxon/build/cjs-browser/luxon.js","./utilities.js":"src/js/modules/utilities.js"}],"src/js/index.js":[function(require,module,exports) {
"use strict";

var _bookApp = _interopRequireDefault(require("./modules/bookApp.js"));

var _navigation = require("./modules/navigation.js");

var _luxon = _interopRequireDefault(require("./modules/luxon.js"));
...
var main = function main() {
  var newApp = new _bookApp.default();
  var $form = (0, _utilities.$)('.form');
  newApp.getLocal();
  (0, _navigation.showPage)(0);
  (0, _luxon.default)();
  (0, _navigation.addLinkFunction)();
...
main();
},{"./modules/bookApp.js":"src/js/modules/bookApp.js","./modules/navigation.js":"src/js/modules/navigation.js","./modules/luxon.js":"src/js/modules/luxon.js","./modules/utilities.js":"src/js/modules/utilities.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
